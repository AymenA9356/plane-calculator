...
var inputTempRef;
var pressureRef;
var fieldElevationRef;
var runwayHeadingRef;
var runwaySlopeRef;
var windDegreesRef;
var windSpeedRef;
var flapRef;
...
var tempArrey;
var headwind, crosswind;//crosswind not used currently due to no need, here for future reference
var dispV1;
var dispVr;
var dispV2;
var dispVClean;
...
var dispPA;
var settingsUsed;
var dispWrongSetConf;
var dispInputErr;

var pressureAltitudeArr= [];
var weightArr= [];
...
,[[108,114,120],[107,114,119], [106,113,118],[105,112,117],[104,111,116],[104,111,116],[103,110,115],[102,109,114],[100,107,112],[/*v1 null*/,/*v2 null*/,/*v3 null*/],/*Vclean*/,/*Vflap*/]

,[[106,113,118],[105,112,118], [104,111,116],[104,111,116],[103,110,115],[102,109,114],[101,109,114],[99,107,111],[/*v1*/,/*v2*/,/*v3*/],[/*v1*/,/*v2*/,/*v3*/],/*Vclean*/,/*Vflap*/]
...
the weight array*/[/*weight 20000*/[/*-40*/[/*v1*/,/*v2*/,/*v3*/],/*-30*/[/*v1*/,/*v2*/,/*v3*/], /*-20*/[/*v1*/,/*v2*/,/*v3*/],/*-10*/[/*v1*/,/*v2*/,/*v3*/],/*0*/[/*v1*/,/*v2*/,/*v3*/],/*10*/[/*v1*/,/*v2*/,/*v3*/],/*20*/[/*v1*/,/*v2*/,/*v3*/],/*30*/[100,106,108],/*40*/[98,106,108],/*50*/[100,106,108],112,/*Vflap*/]

,/*weight 21000*/[[/*v1*/,/*v2*/,/*v3*/],[/*v1*/,/*v2*/,/*v3*/], [/*v1*/,/*v2*/,/*v3*/],[/*v1*/,/*v2*/,/*v3*/],[102,108,111],[102,108,111],[102,108,111],[102,108,111],[102,108,111],[103,109,111],115,/*Vflap*/]

,/*weight 22000*/[[104,110,113],[105,110,113], [105,110,113],[104,110,113],[104,110,113],[104,110,113],[104,111,113],[104,111,113],[105,111,113],[107,111,113],118,/*Vflap*/]

,/*weight 23000*/[[107,112,116],[107,112,116], [107,112,116],[107,112,116],[107,112,116],[107,113,116],[108,113,116],[107,113,116],[108,114,116],[110,115,116],120,/*Vflap*/]

,/*weight 24000*/[[110,114,118],[110,114,118], [110,114,118],[110,114,118],[110,114,118],[110,114,118],[111,116,118],[111,116,118],[111,117,118],[113,117,118],122,/*Vflap*/]

,/*weight 25000*/[[112,117,120],[112,118,120], [113,118,120],[113,118,120],[114,118,120],[114,119,120],[114,119,120],[114,119,120],[115,119,120],[117,119,120],125,/*Vflap*/]

,/*weight 26000*/[[115,120,122],[116,120,122], [116,120,122],[116,120,122],[116,121,122],[116,121,122],[117,121,122],[117,121,122],[118,122,122],[120,122,122],127,/*Vflap*/]

,/*weight 27000*/[[118,122,124],[118,122,124], [119,123,124],[119,123,124],[119,123,124],[120,123,124],[120,123,124],[120,124,124],[120,124,124],[123,124,124],129,/*Vflap*/]

,/*weight 28000*/[[121,125,126],[121,125,126],[122,125,126],[122,125,126],[122,125,126],[123,126,126],[123,126,126],[122,126,126],[124,126,126],[126,126,126],131,/*Vflap*/]

,/*weight 29000*/[[125,127,128],[125,127,128], [125,127,128],[125,127,128],[125,127,128],[125,128,128],[126,128,128],[126,128,128],[127,128,128],[128,128,128],133,/*Vflap*/]]];
...
here beginns the weight array*/[/*weight 20000*/[[/*v1*/,/*v2*/,/*v3*/],[/*v1*/,/*v2*/,/*v3*/], [/*v1*/,/*v2*/,/*v3*/],[/*v1*/,/*v2*/,/*v3*/],[/*v1*/,/*v2*/,/*v3*/],[/*v1*/,/*v2*/,/*v3*/],[100,106,108],[99,106,108],[102,107,108],[102,107,108],127,/*Vflap*/]

,/*weight 21000*/[[/*v1*/,/*v2*/,/*v3*/],[/*v1*/,/*v2*/,/*v3*/],[/*v1*/,/*v2*/,/*v3*/],[/*v1*/,/*v2*/,/*v3*/],[102,107,111],[102,108,111],[100,108,111],[102,108,111],[104,109,111],[106,109,111],130,/*Vflap*/]

,/*weight 22000*/[[/*v1*/,/*v2*/,/*v3*/],[/*v1*/,/*v2*/,/*v3*/], [104,110,113],[104,110,113],[104,110,113],[104,110,113],[103,110,113],[105,111,113],[107,112,113],[109,112,113],133,/*Vflap*/]

,/*weight 23000*/[[107,112,116],[107,112,116], [107,112,116],[107,113,116],[107,113,116],[107,113,116],[106,113,116],[108,114,116],[111,115,116],[113,115,116],135,/*Vflap*/]

,/*weight 24000*/[[109,114,118],[110,114,118], [110,114,118],[110,115,118],[110,115,118],[111,115,118],/*20*/[110,116,118],/*30*/[112,116,118],/*40*/[114,117,118],/*50*/[116,117,118],137,/*Vflap*/]
...
,/*weight 29000*/[[125,127,128],[125,127,128], [125,127,128],[125,127,128],[125,127,128],[125,128,128],[126,128,128],[126,128,128],[127,128,128],/*50*/[128,128,128],133,/*Vflap*/]]];
